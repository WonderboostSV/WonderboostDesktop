...
const FormRegistroCuentaAdministrador = ({ onNext }) => {
    ...
    const handleSubmit = (e) => {
        ...
        onNext(); // Llama a la función para avanzar al siguiente formulario
    };
        ...
        <div className="bg-white dark:bg-gray-800 p-8 flex flex-col justify-center">
            ...
            <form className="space-y-4">
                ...
                <button
                    ...
                    className="w-full bg-slate-900 dark:bg-yellow-500 text-white py-2 px-4 rounded-md shadow-md hover:bg-slate-950 dark:hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-yellow-500 dark:bg-yellow-400 dark:hover:bg-yellow-500"
                >
                    Registrarse
                </button>
            </form>
...
export default FormRegistroCuentaAdministrador;